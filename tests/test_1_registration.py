...
class TestBurgersRegistration:
    ...
    def test_registration_positive(self, driver):
        ...
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.LOGIN_TITLE)))
    ...
    def test_registration_negative(self, driver):
        ...
        registration_button = driver.find_element(By.XPATH, BurgersLocators.REGISTRATION_BUTTON)
        registration_button.click()
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.PASSWORD_ERROR)))
