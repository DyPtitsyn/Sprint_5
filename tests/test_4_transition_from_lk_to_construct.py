...
class TestBurgersFromLkToConstruct:
    def test_transition_from_lk_to_construct_button(self, driver):
        ...
        lk_button = driver.find_element(By.XPATH, BurgersLocators.LK_BUTTON)
        lk_button.click()
        WebDriverWait(driver, 4).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.SAVE_BUTTON)))
        construct_button = driver.find_element(By.XPATH, BurgersLocators.CONSTRUCT_BUTTON)
        construct_button.click()
        WebDriverWait(driver, 4).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.ORDER_BUTTON)))
        order_button = driver.find_element(By.XPATH, BurgersLocators.ORDER_BUTTON)
        assert order_button.is_displayed()

    def test_transition_from_lk_to_logo(self, driver):
        lk_button = driver.find_element(By.XPATH, BurgersLocators.LK_BUTTON)
        lk_button.click()
        login_email = driver.find_element(By.XPATH, BurgersLocators.LOGIN_EMAIL)
        login_email.send_keys(BurgersTestData.AUTH_EMAIL)
        ...
        lk_button = driver.find_element(By.XPATH, BurgersLocators.LK_BUTTON)
        lk_button.click()
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.SAVE_BUTTON)))
        logo = driver.find_element(By.XPATH, BurgersLocators.LOGO)
        logo.click()
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, BurgersLocators.ORDER_BUTTON)))
        order_button = driver.find_element(By.XPATH, BurgersLocators.ORDER_BUTTON)
        assert order_button.is_displayed()
